   ...
   private TextView passtext = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginbtn.setOnClickListener(clk->{
            ...
            if(requirementMet){
                ...
                passtext.setText("You shall not pass monkey!!");
            }
        });
    ...
    boolean checkPasswordComplexity(String password) {
        ...
        if (!foundUpperCase) {
            ...
            Toast.makeText(getApplicationContext(), "your password is missing an upper case letter big black man", Toast.LENGTH_SHORT).show();

            return false;

        } else if (!foundLowerCase) {
            Toast.makeText(getApplicationContext(), "your really be missing a lower case number my guy", Toast.LENGTH_SHORT).show();

            return false;

        } else if (!foundNumber) {
            Toast.makeText(getApplicationContext(), "you really missing a number out here you blind monkey", Toast.LENGTH_SHORT).show();
            return false;
        } else if (!foundSpecial) {
            Toast.makeText(getApplicationContext(), "your missing them special characters buddy", Toast.LENGTH_SHORT).show();
            return false;
        } else
